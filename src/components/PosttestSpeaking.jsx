...
const steps = [
  `Welcome back to Speakai. Are you ready to evaluation practice speaking? Let’s start. Please introduce yourself!`,
  "Okay nice. Next, Look at the picture. Please describe what you see in the picture!",
  "Hello! I have a problem and I need your advice",
  "I feel nervous when speaking English. What do you think I should do?",
  "Do you have any other suggestions?",
  "What else can I do to improve my speaking skills?",
  "What would you do in my shoes to increase confidence?",
  "Alright, Your responses are recorded.",
  "Okay, Next! Let’s discuss a school problem",
  "Today, we will talk about students not keeping the classroom clean. Why is this problem important?",
...
const PosttestSpeaking = ({ lesson, onComplete, onNext, showPopup, saveScore, completedLessons, score, user}) => {
            ...
            {step >= 2 && step <= 7 && (
              <>
                ...
                <span className="text-sm text-cyan-300">
                  Topic: Improving English Speaking Skills
                </span>
              </>
            )}
            {step >= 8 && (
              <>
                Problem Solving <br />
                <span className="text-sm text-cyan-300">
                  Topic: Students Do Not Keep the Classroom Clean
                </span>
              </>
            )}
          </p>
...
export default PosttestSpeaking;